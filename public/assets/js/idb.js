...
let db;
// establish a connection to IndexedDB database called 'pizza_hnt' and set it to version 1
...
request.onupgradeneeded = function(event) {
    ...
    // create an object store (table) called `new_pizza`, set it to hav an auto incrementing primary key of sorts
